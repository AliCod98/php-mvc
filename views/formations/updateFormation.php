				...
				<div class="card-body bg-light">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="nombre_module" class="form-control" placeholder="Nombre Module" value="<?php echo $formation->nombre_module; ?>">
						</div>
						<div class="form-group">
							<label for="description">Description*</label>
							<input type="text" name="description" class="form-control" placeholder="Description" value="<?php echo $formation->description; ?>">
